...
<body>
    <form action="processRegister.php" method="POST" class="bg-primary text-white p-5 rounded container mt-4">
        <h1 class="d-flex justify-content-center">Register</h1>
        <div class="  mb-3">
            <label for="exampleInputuser" class="form-label">Name</label>
            <input name="nama" type="text" class="form-control" id="exampleInputuser">
        </div>
        <div class="  mb-3">
